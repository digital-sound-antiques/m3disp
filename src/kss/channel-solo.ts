import { KSSChannelMask, KSSDeviceName } from "./kss-device";
...
export function soloMaskFor(dev: KSSDeviceName, bits: number[]): KSSChannelMask {
  let bm = 0;
...
export function toggleSolo(mask: KSSChannelMask, dev: KSSDeviceName, bits: number[]): KSSChannelMask {
